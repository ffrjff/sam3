...
def plot_results(img, results, save_path=None, show=True, dpi=150):
    """
    img: PIL.Image 或 numpy array
    results: dict with keys ["masks", "boxes", "scores"]
    save_path: str or None, e.g. "outputs/result.png"
    show: 是否 plt.show()
    dpi: 保存分辨率
    """
    plt.figure(figsize=(12, 8))
    ...
    if save_path is not None:
        ...
        print(f"[Saved] result image -> {save_path}")
